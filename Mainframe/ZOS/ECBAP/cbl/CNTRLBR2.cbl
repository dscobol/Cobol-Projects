       ...
       01  WORKING-NUMERICS.
           ...
           05  WARD-COUNT-BY-TOTALS        PIC 9(5).
           05  WARD-COUNT-BY-HOSP          PIC 9(5).
       ...
       01  WARD-HEADER-LINE.
           05  FILLER                     PIC X(8)
                                          VALUE '     NEW'.
           05  FILLER                     PIC X(8) VALUE " WARD:".
           05  RPT-HDR-WARD                  PIC X(20).
       ...
       01  WARD-TRAILER.
           ...
           05  FILLER                     PIC X(13)
                                                  VALUE " WARD TOTALS".
           05  WARD-SUMM                  PIC X(22).
           05  WARD-SUMMARY-AMOUNT                PIC $,$$$,$$9.99.
           05  FILLER                     PIC X(9) VALUE SPACES.
           05  WARD-SUMMARY-PATIENT-COUNT        PIC Z,ZZ9.
       ...
       01  HOSP-TRAILER.
           ...
           05  HOSP-SUMMARY-WARD-COUNT    PIC ZZZ,ZZ9.
           05  FILLER                     PIC X(11) VALUE " WARDS ".
           05  HOSP-SUMMARY-PATIENT-COUNT PIC ZZZ,ZZ9.
           05  FILLER                     PIC X(12) VALUE " PATIENTS ".
       ...
       01  TOTALS-TRAILER.
           ...
           05  FILLER                     PIC X(12) VALUE " PATIENTS ".
           05  RPT-TRLR-WARD-COUNT           PIC ZZZ,ZZ9.
           05  FILLER                     PIC X(9) VALUE " WARDS ".
       ...
       01  WARD-UNDERSCORE-LINE                PIC X(60)
            VALUE '     ----------------------------------------------'.
       ...
       000-HOUSEKEEPING.
           ...
           MOVE ZERO                      TO WARD-COUNT-BY-TOTALS.
       ...
       900-WRAP-UP.
           ...
           MOVE WARD-COUNT-BY-TOTALS        TO RPT-TRLR-WARD-COUNT.
      ...
      ** Is the hold-inner-control break field = input-control-break-field?
      ...
      ** Both hold-control-break fields are equal
       ...
       HOSP-INITIAL.
           ...
           MOVE ZERO                      TO WARD-COUNT-BY-HOSP.
       ...
       WARD-INITIAL.
           ...
           WRITE REPORT-RECORD         FROM WARD-HEADER-LINE.
           WRITE REPORT-RECORD         FROM WARD-UNDERSCORE-LINE.
       ...
       PATIENT-NORMAL-PROCESS.
           ...
           ADD 1                       TO PATIENT-COUNT-BY-WARD.
      ...
      **   20 == Outer Control Break
               ...
               ELSE IF INFILE-WARD NOT = HOLD-WARD
      **   10 == Innter control break
      ...
      **   0 == Detail line process
       ...
       WARD-SUMMARY.
           ...
           WRITE REPORT-RECORD       FROM BLANK-LINE.
           ADD AMOUNT-BY-WARD             TO AMOUNT-BY-HOSP.
           ADD PATIENT-COUNT-BY-WARD      TO PATIENT-COUNT-BY-HOSP.
           ADD 1                          TO WARD-COUNT-BY-HOSP.

       HOSP-SUMMARY.
           MOVE HOLD-HOSP                 TO HOSP-SUMM.
           MOVE AMOUNT-BY-HOSP            TO HOSP-SUMMARY-AMOUNT.
           WRITE REPORT-RECORD       FROM BLANK-LINE.
           MOVE WARD-COUNT-BY-HOSP        TO HOSP-SUMMARY-WARD-COUNT.
           ...
           ADD WARD-COUNT-BY-HOSP         TO WARD-COUNT-BY-TOTALS.
