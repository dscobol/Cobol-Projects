      ...
      *
      *    THIS PROGRAM WILL RECEIVE A DATE AND CONVERT THE DATE TO
      ...
      *
       01  CALL-FIELDS.
           05  W-CALL-PROGRAM       PIC X(8).
           05  W-RETIREMENT-WA          PIC 9(4).
           05 W-RET-CODE             PIC S9(4).
           05  W-DIAGNOSTIC             PIC 9(4).
      ...
      *
       A100-VERIFY-INPUT-DATE SECTION.
           ...
           END-IF
           CALL 'DTEVAL' USING L-INPUT-DATE,W-RET-CODE
           MOVE W-RET-CODE TO W-DIAGNOSTIC
           .
      *
       END-OF-SECTION.
           EXIT.
